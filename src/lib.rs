...
#[inline]
fn trace_complex(z:Complex<f64>, i: u32, size_x: usize, size_y:usize, x_min: f64, x_max:f64, y_min: f64, y_max: f64, min_iteration: u32, max_iteration: u32, image: &mut [u16], nb_color: usize, color_offset: usize) -> u32 {
    let mut score = 0;
    let coord_x = ((z.re-x_min)/(x_max-x_min)*size_x as f64) as i32;
    let coord_y = ((z.im-y_min)/(y_max-y_min)*size_y as f64) as i32;
...
pub fn gen_buddhabrot_metropolis_color(size_x: usize, size_y:usize, x_min: f64, x_max:f64, y_min: f64, y_max: f64, red_min_iteration: u32, red_max_iteration: u32, green_min_iteration: u32, green_max_iteration: u32, blue_min_iteration: u32, blue_max_iteration: u32, num_sample: u32, image: &mut [u16]) -> Result<()> {
    ...
    'main_loop: for _ in 0..num_sample {
        ...
        if escaped {
            ...
            while (z.re*z.re+z.im*z.im) < 4f64 {
                // red
                score += trace_complex(z, i, size_x, size_y, x_min, x_max, y_min, y_max, red_min_iteration, red_max_iteration, image, 3, 0);
                // green
                score += trace_complex(z, i, size_x, size_y, x_min, x_max, y_min, y_max, green_min_iteration, green_max_iteration, image, 3, 1);
                // blue
                score += trace_complex(z, i, size_x, size_y, x_min, x_max, y_min, y_max, blue_min_iteration, blue_max_iteration, image, 3, 2);
